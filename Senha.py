...
def alternar_senha1():
    entrada_novasenha.configure(show="" if check_senha1.get() else "*")
...
# Campo nova senha
entrada_novasenha = ctk.CTkEntry(janela, placeholder_text="Insira a nova senha", show="*")
entrada_novasenha.pack(pady=5)
...
confirmar_novasenha = ctk.CTkEntry(janela, placeholder_text="Digite novamente a nova senha", show="*")
